                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-7">
                                ...
                                <form class="cart" method="post">
                                    <div class="quantity">
                                        <span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp&ampqty &gt  ) effect.value--;return false;"><i class="fa fa-minus" aria-hidden="true"></i></span>
