			...
			<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
				...
				<form action="<?= base_url('pelanggan/changePassword') ?>" method="post">
					<h4 class="mtext-105 cl2 txt-center p-b-30">
						New Password for Email <?= $this->session->userdata('reset_email'); ?>
					</h4>

					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" id="password1" name="password1" placeholder="Password">
						<img class="how-pos4 pointer-none" src="<?= base_url() ?>template/images/icons/icon-email.png" alt="ICON">
					</div>
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" id="password2" name="password2" placeholder="Repeat Password">
						<img class="how-pos4 pointer-none" src="<?= base_url() ?>template/images/icons/icon-email.png" alt="ICON">
					</div>
